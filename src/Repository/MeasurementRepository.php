...
class MeasurementRepository extends ServiceEntityRepository
{
    ...
    public function aggregatedTotalMeasurement(){
        return $this->createQueryBuilder('m')
            ->select("m.regionName, m.pollutant, sum(m.measurement) as measurement")
            ->groupBy('m.regionName','m.pollutant')
            ->orderBy('m.pollutant', 'ASC')
            ->getQuery()
            ->getResult();
    }
